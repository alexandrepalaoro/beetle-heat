...
> Giacometti, D., Silva, L.H.L., Gomes, G., de Carvalho, J.E. & Palaoro, A.V. (2026) *Data and code for: Regional heterothermy in Megasoma gyas is not related to active heat dissipation by the horns* [Data set]. Zenodo. https://doi.org/ZENODO_DOI_HERE
...
1. Go to [zenodo.org/account/settings/github](https://zenodo.org/account/settings/github),
   log in with GitHub, and flip the switch **on** for `alexandrepalaoro/beetle-heat`.
